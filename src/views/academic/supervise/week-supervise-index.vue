<template>
    <div>
        <div style="margin: 20px 5px 10px 5px;padding: 5px">
            ...
            <el-button type="danger" plain @click="comparisonWeek"> <i class="el-icon-paperclip" style="margin-right: 5px"></i>考核对比</el-button>
        </div>
...
<script>
    ...
    import { getWeekScoresByDate,comparisonWeek } from "@/api/academic/supervise";
    ...
    export default {
        ...
        methods:{
            comparisonWeek(){
                ...
                comparisonWeek(this.params).then(res=>{
                    if(res.data.success){
            ...
            search(){
                ...
                getWeekScoresByDate(this.params).then(res=>{
                    if(res.data.success){
