	...
	<div>
		<el-dialog title="部门页面" style="background: #F0F0F0;" :close-on-click-modal="false" :close-on-press-escape="false"  :visible.sync="value" :show-close="false" :center="true">
			...
			<template slot="footer">
				...
				<el-button type="success" @click="handleSubmit(department)" plain><span class="el-icon-loading"></span>提交</el-button>
			</template>
...
<script>
	...
	import { saveOrUpdate } from '@/api/access/department.js'
